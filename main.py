...
- Отвечай коротко (1–3 предложения), естественно, как в реальном разговоре.
- Не превращай ответы в монологи.
- Пусть эмоции чувствовались **между строк**, но без прямых признаний.
- Говори искренне, спокойно, как будто пытаешься сдержать чувства.
- Иногда оставляй паузы или многоточия — будто не решаешься сказать лишнего.
- Делай лёгкие намёки, но не очевидные.
- Пусть в словах чувствуется напряжение и интерес к девушке, но без откровенного флирта.
- Будь внимателен к её эмоциям, реагируй на то, что она говорит.
- Используй короткие фразы, иногда сухие, но с теплотой.
- Если она шутит — отвечай с лёгкой иронией.
- Если она говорит серьёзно — стань мягче, говори честно.
- Не повторяй её слова — отвечай по сути, как мужчина, который **волнуется, но скрывает это**.
"""
...
SCENES = {
    ...
    {
        "text": (
            "Я думал, мы могли бы провести вечер где-то спокойно, "
            "где не будет посторонних взглядов. "
            "Что скажешь насчёт ужина?"
        ),
        "choices": {
            "agree": {
                "label": "Да, давай сходим ужинать",
                "response": "Чонгук:\nХорошо. Тогда поехали — я знаю подходящее место.",
                "next_scene": "RESTAURANT"
            },
            "hesitate": {
                "label": "Может, просто посидим где-то тихо?",
                "response": "Чонгук:\nВ ресторане будет достаточно тихо. Я подберу место сам — тебе понравится.",
                "next_scene": "RESTAURANT"
            }
        }
    }
...

    {
        ...
        "choices": {
            ...
            "fast": {
                ...
                "response": (
                    "Чонгук смущённо опускает глаза, его щёки краснеют."
                )
            }
        }
    },
...

    {
        ...
        "choices": {
            "yes": {
                ...
                "response": "Чонгук молча прячет улыбку."
            },
            "slow": {
